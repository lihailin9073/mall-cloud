...
public class Swagger2Config {
    ...
    Docket docket1() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("开放API")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.wzliulan.mall.cloud.system.controller.open"))
    ...
    private ApiInfo getApiInfo1() {
        return new ApiInfoBuilder()
                .title("[系统微服务]接口文档")
                .version("2021.0.1")
                .description("系统微服务-用户、角色、权限/菜单等服务接口")
    ...
    Docket docket2() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("Feign-API")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.wzliulan.mall.cloud.system.controller.feign"))
                .paths(PathSelectors.any())
                .build()
