...
public class RedisKeyTemplate {
    ...
    // 文章微服务的Redis键名模板
    public static final String REDIS_KEY_PREFIX_ARTICLE_TEMPLATE = "mall:cloud:article:%s";
    // 问答微服务的Redis键名模板
    public static final String REDIS_KEY_PREFIX_QUESTION_TEMPLATE = "mall:cloud:question:%s";
    // 系统微服务的Redis键名模板
