package com.wzliulan.mall.cloud.generator;
...
public class CodeGenerator {
    ...
    // 生成的代码放到哪个工程中
    private static String PROJECT_NAME = "mall-goods";

    // 数据库名称
    private static String DATABASE_NAME = "mall-cloud-goods";

    // 子包名
    private static String MODULE_NAME = "goods";

    // 实体模型
    private static String ENTITY_NAME = "domain.model.mall.goods";
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("lihailin973,767679879@qq.com,13802780104");
        ...
        pc.setParent("com.wzliulan.mall.cloud"); //父包名
        pc.setController(MODULE_NAME+".controller"); // com.wzliulan.mall.cloud.article.controller
        ...
        pc.setEntity(ENTITY_NAME); // 实体类存储包名 com.wzliulan.mall.cloud.model
