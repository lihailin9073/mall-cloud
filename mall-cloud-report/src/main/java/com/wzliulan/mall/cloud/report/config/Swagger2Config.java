package com.wzliulan.mall.cloud.report.config;
...
public class Swagger2Config {
    ...
    Docket docket1() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("开放接口")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.wzliulan.mall.cloud.report.controller.open"))
    ...
    private ApiInfo getApiInfo1() {
        return new ApiInfoBuilder()
                .title("[生意参谋微服务]接口文档")
                .version("2021.0.1")
                .description("生意参谋微服务-品类、品牌、生意参谋、属性等服务接口")
    ...
    Docket docket3() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("管理接口")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.wzliulan.mall.cloud.report.controller.security"))
                .paths(PathSelectors.any())
                .build()
