 ...
 * @since 2021-04-17
 */
public interface GoodsTypeMapper extends BaseMapper<Type> {
    /**
     * 类型管理列表查询方法
     * @param page 分页对象
     ...
     */
    IPage<GoodsTypeDomain> typeManageList(IPage<GoodsTypeDomain> page, @Param("typeQueryDto")TypeQueryDto typeQueryDto);
}
